...
ActiveRecord::Schema[8.0].define(version: 2025_11_05_073014) do
  ...
  create_table "invitations", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["invited_to_id"], name: "index_invitations_on_invited_to_id"
  ...
  add_foreign_key "invitations", "events", column: "invited_to_id"
